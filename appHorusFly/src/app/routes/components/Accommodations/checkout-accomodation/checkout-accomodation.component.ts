...
export class CheckoutAccomodationComponent {
  ...
  formDatos() {
    ...
    const combinationArray = JSON.parse(sessionStorage.getItem('form') || '[]');
    combinationArray.push(formCombined);
    sessionStorage.setItem('form', JSON.stringify(combinationArray));
